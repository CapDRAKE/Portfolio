			...
			<!--PHP d'insertion du produit dans la base de donnée -->
				<?php
						...
						if(isset($_POST['nom'])&&isset($_POST['prix'])){
							$nom = $_POST['nom'];
							$prix = $_POST['prix'];
							$changement = mysqli_query($bdd, "UPDATE produits SET prixProduit ='".$prix."' WHERE nomProduit = '".$nom."';");
