...
portfolio_render_start([
    'title' => 'Bastien Leuwers | Developpeur Full Stack',
    'description' => 'Bastien Leuwers, developpeur Full Stack a dominante Java.',
    'active' => 'home',
]);
?>
      ...
      <div class="section-shell split-layout">
        <div>
          ...
          <div class="hero-actions">
            ...
            <a class="btn btn-secondary" href="cv/CV_Bastien_Leuwers.pdf" target="_blank" rel="noopener">Ouvrir mon CV</a>
          </div>
        </div>
    ...
    <section class="site-section reveal">
      <div class="contact-strip">
        ...
        <div class="hero-actions">
          ...
          <a class="btn btn-secondary" href="projet.php">Voir tous les projets</a>
        </div>
      </div>
    </section>
  </main>
