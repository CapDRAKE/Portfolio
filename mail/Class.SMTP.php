...
class SMTP {
    ...
    var $NomDuDomaine = 'portfolio-leuwers-bastien.w2.websr.fr';

    // De Qui
    var $From = 'contact@portfolio-leuwers-bastien.w2.websr.fr';// Adresse de l' expéditeur
    var $FromName = 'Portfolio Bastien LEUWERS';// Nom de l' expéditeur
    var $ReplyTo = 'contact@portfolio-leuwers-bastien.w2.websr.fr';// Adresse de retour
    var $org = 'Portfolio Bastien LEUWERS'; // Organisation

    // A Qui
    var $To = 'contact@portfolio-leuwers-bastien.w2.websr.fr';
    ...
    var $Confimation_reception = 'bastienleuwers2@gmail.com';// Entrez l' adresse où sera renvoyé la confirmation

    // Le mail
    var $Sujet = 'Envoie de la page';
    var $Body = 'test';
    var $Body_txt = 'test';
    ...
    var $serveur = 'portfolio-leuwers-bastien.w2.websr.fr';// Serveur SMTP
    var $port = 25;// Port SMTP
    var $login_smtp = 'contact@portfolio-leuwers-bastien.w2.websr.fr';// Login pour le serveur SMTP
    var $mdp_smtp = 'LA.muette.rieuse13';// Mot de passe pour le serveur SMTP
    ...
    var $erreur = 'Erreur de connexion';
    var $debug = false;
