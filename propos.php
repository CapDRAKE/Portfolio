...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/propos.jpg')">
...
<center><iframe src="cv/CVbastien.pdf" width="600" height="800" align="middle"></iframe></center>
	...
	<section class="container">
		<br/>
		  <hr>
		<header>
			<center><h2>Mon parcours</h2></center>
		</header>
		  <hr>
	<div class="row">
		<div class="col-4 col-12-medium">
			<section class="middle">
				<br/><br/>
				<img src="img/truffaut.JPG" style="width:330px;"/>
				<br/><br/><br/>
				<header>
		...
		<div class="col-4 col-12-medium">
			<section class="middle">
				<br/><br/>
				<img src="img/batterie.jpg" style="width:330px;"/>
				<br/><br/><br/>
				<header>
		...
		<div class="col-4 col-12-medium">
			<section class="middle">
				<br/><br/><br/>
				<center><img src="img/vtt.jpg" style="width:330px;"/></center>
				<br/><br/>
				<header>
					<h2>VTT</h2>
				</header>
